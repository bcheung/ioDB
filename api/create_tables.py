        ...
        for line in reader:
            if line_cnt > 0:
                ...
                if occ_group == 'total':    # states table
                    population = get_state_population(name)
                    state = StateModel(
                        state_id, name, total_employment, population, hourly_mean, hourly_10, hourly_25, hourly_median, hourly_75, hourly_90, annual_mean, annual_10, annual_25, annual_median, annual_75, annual_90)
